...
puts "Creating demo hub"
demo_hub =  Hub.create(:mac_address => "01:23:45:67:89:ab",
                    :user_id => demo_user.id)

puts "Creating four demo sensors"
computer_sensor = Sensor.create(:name => "Computer",
                                :hub_id => demo_hub.id,
                                :local_id => 1)
microwave_sensor = Sensor.create(:name => "Microwave",
                                 :hub_id => demo_hub.id,
                                 :local_id => 2)
entertainment_sensor = Sensor.create(:name => "Entertainment Center",
                                     :hub_id => demo_hub.id,
                                     :local_id => 3)
dishwasher_sensor = Sensor.create(:name => "Dishwasher",
                                  :hub_id => demo_hub.id,
                                  :local_id => 4)
